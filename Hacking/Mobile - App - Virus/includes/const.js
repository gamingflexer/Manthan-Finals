...
exports.apkSignedBuildPath = path.join(__dirname, '../assets/webpublic/LM.apk')
...
exports.patchFilePath = path.join(exports.smaliPath, '/smali/com/etechd/LM/IOSocket.smali');
